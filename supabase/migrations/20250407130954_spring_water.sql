/*
  # Create Church Management System Tables
  ...
  1. New Tables
    ...
    - `baptized` - Stores baptism information
      - `BAPTISM_ID` (uuid, primary key)
      - `MEMBER_ID` (uuid, foreign key)
      - `BAPTIZED` (text, enum: 'Yes', 'No')
      - `DATE_BAPTIZED` (date)
    ...
    - `confirmation` - Stores confirmation information
      - `CONFIRMATION_ID` (uuid, primary key)
      - `MEMBER_ID` (uuid, foreign key)
      - `CONFIRMED` (text, enum: 'Yes', 'No')
      - `CONFIRMATION_DATE` (date)
      - `CHURCH_CONFIRMED` (text)
      - `CONFIRMATION_NO` (text)

    - `married` - Stores marriage information
      - `MARRIAGE_ID` (uuid, primary key)
      - `MEMBER_ID` (uuid, foreign key)
      - `MARRIAGE_STATUS` (text, enum: 'Single', 'Married', 'Widowed', 'Divorced')
      - `MARRIAGE_DATE` (date)
      - `CHURCH_MARRIED` (text)
      - `MARRIAGE_NO` (text)
